...
! +                                                           +
! + config_tools.f90                                          +
! +    - part of the SPA (soil-plant-atmosphere) model        +
! +                                                           +
! +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
! 
! Copyright (C) 2011 SPA contributors - see AUTHORS file for
...
! (see COPYING file) along with this program; if not, write to the 
! Free Software Foundation, Inc., 59 Temple Place, Suite 330, ,
! Boston, MA, 02111-1307 USA
!
! SPA is maintained by:          Mathew Williams
...
!
! SPA is hosted by the Centre for Earth System Dynamics, 
!  within The University of Edinburgh, at...
!
! https://svn-kerberos.ecdf.ed.ac.uk/repo/geos/CESD/SPA
!
! -------------------------------------------------------------
...
module config_tools
  ...
  !!  This code also reads the setup values for the EnKF          !!
  !!  simulation.
  !!                                                              !!
